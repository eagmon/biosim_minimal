...
${e.stack ? e.stack : e}`);
    ...
    return Object.assign(Object.assign({}, (0, cypress_preset_1.nxBaseCypressPreset)(pathToConfig)), { 
        ...
        specPattern: ['src/**/*.cy.ts', 'src/**/*.cy.js'], devServer: Object.assign(Object.assign({}, {
            framework: 'angular',
            bundler: 'webpack',
        }), { options: {
...
function normalizeBuildTargetOptions(buildContext, ctContext, offset) {
    ...
    buildOptions.polyfills =
        Array.isArray(buildOptions.polyfills) && buildOptions.polyfills.length > 0
            ? buildOptions.polyfills.map((p) => (0, devkit_1.joinPathFragments)(offset, p))
            : (0, devkit_1.joinPathFragments)(offset, buildOptions.polyfills);
...
Note: this may fail, setting the correct 'sourceRoot' for ${buildContext.projectName} in the project.json file will ensure the correct value is used.`);
    ...
    return {
        root: (0, devkit_1.joinPathFragments)(offset, config.root),
        sourceRoot: (0, devkit_1.joinPathFragments)(offset, config.sourceRoot),
        buildOptions,
    };
}
...
function getTempStylesForTailwind(ctExecutorContext) {
    ...
    const isTailWindInCtProject = (0, fs_1.existsSync)(ctProjectTailwindConfig + '.js') ||
        (0, fs_1.existsSync)(ctProjectTailwindConfig + '.cjs');
    const rootTailwindPath = (0, path_1.join)(ctExecutorContext.root, 'tailwind.config');
    const isTailWindInRoot = (0, fs_1.existsSync)(rootTailwindPath + '.js') ||
        (0, fs_1.existsSync)(rootTailwindPath + '.cjs');
