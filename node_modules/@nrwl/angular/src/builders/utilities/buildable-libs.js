...
function createTmpTsConfigForBuildableLibs(tsConfigPath, context, target) {
    let dependencies;
    const result = (0, buildable_libs_utils_1.calculateProjectDependencies)((0, devkit_1.readCachedProjectGraph)(), context.workspaceRoot, context.target.project, target !== null && target !== void 0 ? target : context.target.target, context.target.configuration);
