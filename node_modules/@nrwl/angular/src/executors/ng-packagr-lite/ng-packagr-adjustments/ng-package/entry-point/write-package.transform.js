...
const nxWritePackageTransform = (options) => (0, transform_1.transformFromPromise)((graph) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!ngEntryPoint.isSecondaryEntryPoint) {
        ...
        try {
            yield copyAssets(graph, entryPoint, ngPackageNode);
        }
        catch (error) {
            throw error;
        }
...
function copyAssets(graph, entryPointNode, ngPackageNode) {
    var _a;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const asset of assets) {
            const filePaths = yield (0, glob_1.globFiles)(asset.glob, {
                cwd: asset.input,
