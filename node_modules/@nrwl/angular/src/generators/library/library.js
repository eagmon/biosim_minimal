...
function libraryGenerator(tree, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const userInstalledAngularVersion = (0, version_utils_2.getInstalledAngularVersionInfo)(tree);
        ...
        const runAngularLibrarySchematic = wrapAngularDevkitSchematic('@schematics/angular', 'library');
        ...
        if (libraryOptions.ngCliSchematicLibRoot !== libraryOptions.projectRoot) {
            (0, devkit_1.moveFilesToNewDirectory)(tree, libraryOptions.ngCliSchematicLibRoot, libraryOptions.projectRoot);
        }
        yield (0, update_project_1.updateProject)(tree, libraryOptions);
