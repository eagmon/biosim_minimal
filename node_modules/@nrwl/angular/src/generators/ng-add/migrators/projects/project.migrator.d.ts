...
export declare class ProjectMigrator<TargetType extends string = string> extends Migrator {
    ...
    protected skipMigration: boolean | TargetType[];
    ...
    private skipTargetTypeMigration;
}
