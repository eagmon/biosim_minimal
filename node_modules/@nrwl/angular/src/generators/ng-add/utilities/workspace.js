...
function updatePrettierConfig(tree) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (!existingPrettierConfig) {
            (0, devkit_1.writeJson)(tree, '.prettierrc', generate_workspace_files_1.DEFAULT_NRWL_PRETTIER_CONFIG);
        }
...
exports.updatePrettierConfig = updatePrettierConfig;
