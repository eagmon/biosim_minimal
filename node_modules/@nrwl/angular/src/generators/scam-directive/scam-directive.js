...
function scamDirectiveGenerator(tree, rawOptions) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const angularDirectiveSchematic = wrapAngularDevkitSchematic('@schematics/angular', 'directive');
...
function checkPathUnderProjectRoot(tree, options) {
    ...
    const project = (_a = options.project) !== null && _a !== void 0 ? _a : (0, devkit_1.readNxJson)(tree).defaultProject;
