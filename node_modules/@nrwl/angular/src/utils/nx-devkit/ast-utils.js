...
function _addSymbolToDecoratorMetadata(host, source, filePath, metadataField, expression, decoratorName) {
    ...
    if (matchingProperties.length == 0) {
        ...
        return (0, ast_utils_1.insertChange)(host, source, filePath, position, toInsert);
    }
...
function getListOfRoutes(source) {
    ...
    if ((imports === null || imports === void 0 ? void 0 : imports.initializer.kind) === ts.SyntaxKind.ArrayLiteralExpression) {
            ...
            if (e.kind === ts.SyntaxKind.CallExpression) {
                ...
                if ((text === 'RouterModule.forRoot' ||
                    ...
                    if (routes.kind === ts.SyntaxKind.ArrayLiteralExpression) {
                        ...
                        const variableDeclarations = (0, typescript_1.findNodes)(source, ts.SyntaxKind.VariableDeclaration);
...
function addProviderToBootstrapApplication(tree, filePath, providerToAdd) {
    ...
    const providersArrayNodes = (0, tsquery_1.tsquery)(ast, PROVIDERS_ARRAY_SELECTOR, {
