...
exports.registerPluginTSTranspiler = exports.resolveLocalNxPlugin = exports.readPluginPackageJson = exports.mergePluginTargetsWithNxTargets = exports.loadNxPlugins = void 0;
...
function loadNxPlugin(moduleName, paths, root) {
    let pluginPath;
    try {
...
function loadNxPlugins(plugins, paths = [workspace_root_1.workspaceRoot], root = workspace_root_1.workspaceRoot) {
    ...
    if (!nxPluginCache) {
        nxPluginCache = plugins.map((moduleName) => loadNxPlugin(moduleName, paths, root));
    }
